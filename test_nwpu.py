...
from datasets import NWPUTest, Resize2Multiple, ZeroPad2Multiple
...
def main(args: ArgumentParser):
    ...
    dataset = NWPUTest(transforms=args.transforms, return_filename=True)
...
if __name__ == "__main__":
    ...
    if args.sliding_window:
        ...
        if args.zero_pad_to_multiple:
            args.transforms = ZeroPad2Multiple(window_size=args.window_size, stride=args.stride)
        elif args.resize_to_multiple:
            args.transforms = Resize2Multiple(window_size=args.window_size, stride=args.stride)
        else:
